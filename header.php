...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-125636590-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-125636590-1');
</script>
	...
	<body <?php body_class(); ?>>
		<h6 style="background: #ffe566;text-align: center;font-weight: 700;color: #ffffff;">
			Дорогі Клієнти, з 1 жовтня по 1 листопада ми закриваємось на ремонт. В Цей період замовлення прийматися не будуть. Дякуємо за розуміння, та чекаємо на Вас в листопаді)
		</h6>
		...
		<div id="container">
			...
			<?php if (!$zass_is_blank): ?>
				...
				<?php if (zass_get_option('enable_pre_header') && is_active_sidebar('pre_header_sidebar')): ?>
					<div id="pre_header"> <a href="#" class="toggler" id="toggle_switch" title="<?php esc_html_e('Show/Hide', 'zass') ?>"><?php esc_html_e('Slide toggle', 'zass') ?></a>
							...
							<div class="zass-search-cart-holder">
								...
								<?php if (ZASS_IS_WOOCOMMERCE && ZASS_IS_WISHLIST && zass_get_option('show_wish_in_header')): ?>
									<div class="zass-wishlist-counter">
										<a href="<?php echo esc_url(YITH_WCWL()->get_wishlist_url()); ?>" title="<?php echo esc_html__('Wishlist', 'zass') ?>">
								...
								<?php if (ZASS_IS_WOOCOMMERCE && zass_get_option('show_my_account') && get_option( 'woocommerce_myaccount_page_id' ) ): ?>
                                    ...
                                    <div id="zass-account-holder">
                                        <a href="<?php echo esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>" title="<?php esc_html_e( 'My Account', 'zass' ); ?>">
